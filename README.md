...
- :gem: In the stage 1, a pixel-space loss function is introduced to alleviate the problem of blurry generated images, while the features of dinov3 are used to enhance shadow removal capabilities.
- :gem: We skipped stage 2 because we found it had limited impact on the final result in this task.
- :gem: In the stage 3, we introduce FFL (Focal Frequency Loss) to help VAE better reconstruct image details.
